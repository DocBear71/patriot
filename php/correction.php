...
<html lang='en'>
    <head>
        <title>Thank you for Submitting a Correction</title>
        <meta charset="utf-8">
    ...
    <body>
        <header>
            <h1>Patriot Thanks<br>
                Correction Submission Complete
            </h1>
        </header>
        <nav>
            <ol id="menu">
        ...
        <main>
            <p>Thank you for submitting a correction to Patriot Thanks. We will respond within two (2) business days.</p>
            <br>
