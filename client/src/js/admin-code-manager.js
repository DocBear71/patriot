...
async function loadExistingCodes() {
    try {
        ...
        const response = await fetch(`${baseURL}/api/admin-codes.js?operation=list`, {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${token}`,
                'Cache-Control': 'no-cache'
...
async function handleCreateCode(event) {
    ...
    try {
        ...
        const response = await fetch(`${baseURL}/api/admin-codes.js?operation=create`, {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${token}`,
...
async function handleDeleteCode(event) {
    ...
    try {
        ...
        const response = await fetch(`${baseURL}/api/admin-codes.js?operation=delete`, {
            method: 'DELETE',
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
