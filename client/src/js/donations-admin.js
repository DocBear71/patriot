...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadDonationStats() {
        ...
        fetch('/api/donations.js?operation=stats', {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${userToken}`
            }
    ...
    function loadDonations() {
        ...
        // Fetch donations
        fetch(`/api/donations.js?${queryParams}`, {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${userToken}`
            }
    ...
    function showDonationDetails(donationId) {
        ...
        fetch(`/api/donations.js?operation=get&id=${donationId}`, {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${userToken}`
            }
    ...
    function sendReceiptEmail(donationId) {
        fetch('/api/donations.js?operation=send-receipt', {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${userToken}`,
    ...
    function cancelRecurringDonation(donationId) {
        ...
        fetch('/api/donations.js?operation=cancel-recurring', {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${userToken}`,
                'Content-Type': 'application/json'
    ...
    function exportDonations() {
        ...
        const downloadUrl = `/api/donations.js?${queryParams}`;
